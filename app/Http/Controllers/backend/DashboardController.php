...
class DashboardController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.dashboard', compact('user', 'employee', 'employeesCount','company', 'physicianCount', 'clinicianCount', 'visits', 'patients','clinicianmonthCount','physicianmonthCount','visitsmonthcount','patientsmonthcount'));
        /* return view('home');
        /* return view('home');
        dd($patientCount);        
