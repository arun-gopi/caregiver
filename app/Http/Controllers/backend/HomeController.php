...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.home', compact('employeesCount', 'physicianCount', 'clinicianCount', 'visits', 'patients','clinicianmonthCount','physicianmonthCount','visitsmonthcount','patientsmonthcount'));
        /* return view('home');
